...
class ClanInfo$Type extends MessageType<ClanInfo> {
    constructor() {
        super("rustplus.ClanInfo", [
            ...
            { no: 6, name: "motdTimestamp", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/ },
            { no: 7, name: "motdAuthor", kind: "scalar", opt: true, T: 4 /*ScalarType.UINT64*/ },
